...
Trend: increasing
P-value: 0.0007
Overall ATS Slope (per year): 0.3658
Intercept: -8.1381
95% CI for Slope: (0.0442, 0.6528)
```
...
In this example, both methods detect a significant increasing trend, but the ATS method provides a slope estimate that is closer to the true underlying trend of 0.10. The plot shows the final trend line generated by the ATS method.
