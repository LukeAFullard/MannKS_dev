...
In this example, both methods detect a significant increasing trend, but the ATS method provides a slope estimate that is closer to the true underlying trend of {true_slope_per_year:.2f}. The plot shows the final trend line generated by the ATS method.
