# Example 25: Advanced Parameter Nuances\n\nThis example demonstrates several advanced or less common parameters in the `MannKenSen` package.\n
---
## 1. Tau Method ('a' vs. 'b')
```python
import numpy as np
...
**Output:**
```
Default classification: Highly Likely Increasing
Custom classification: Virtually Certain Increasing
```
...
**Output:**
```
Default min_size=10 Note: 'sample size (8) below minimum (10)'
Custom min_size=8 Trend: 'increasing'
```
...
**Output:**
```
Trend: 'increasing', Slope: 0.00103 units/day
```
