"""
This script generates the guide for the inspect_trend_data function.
"""
import os
import textwrap
import io
...
def generate_guide():
    ...
    readme_content = (
        ...
        "```\n\n"
        f"{textwrap.dedent(param_text).strip()}\n"
    )
    ...
    print(f"Successfully generated README for inspect_trend_data at {readme_path}")
