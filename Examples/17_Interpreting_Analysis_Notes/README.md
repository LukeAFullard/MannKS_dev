...
Analysis Notes:
  ...
  - sample size (4) below minimum (10)

--- Scenario: Long Run of Single Value ---
Time: [2000 2001 2002 2003 2004 2005 2006 2007 2008 2009]
Values: [5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 6.0, 7.0, 8.0, 9.0]
Trend: increasing
Sen's Slope: 0.4000
Analysis Notes:
  - Long run of single value

--- Scenario: Sen Slope Influenced by Censored Values ---
Time: [1, 2, 3]
Values: ['<1', 2, 3]
...
Analysis Notes:
  - < 3 unique values
  - sample size (3) below minimum (10)
