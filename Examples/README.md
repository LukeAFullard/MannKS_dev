...
*   [**Example 05: Basic Seasonal Trend Test**](./05_Basic_Seasonal_Trend_Test/README.md)

### Part 2: Handling Complex & Messy Data
*   [**Example 06: Deep Dive into Censored Data Options**](./06_Censored_Data_Options/README.md)
*   [**Example 07: The High Censor Rule (`hicensor`)**](./07_High_Censor_Rule/README.md)
*   [**Example 08: Aggregation for Tied and Clustered Data**](./08_Aggregation_Tied_Clustered_Data/README.md)
*   [**Example 09: Comparing Right-Censored Data Methods (`mk_test_method`)**](./09_Right_Censored_Methods/README.md)
...
*   [**Example 11: Advanced Seasonality (Non-Monthly Data)**](./11_Advanced_Seasonality/README.md)
*   [**Example 12: The Impact of Censored Data Multipliers**](./12_Censored_Data_Multipliers/README.md)
*   [**Example 13: Comparing Confidence Interval Methods**](./13_Confidence_Interval_Methods/README.md)
*   [**Example 14: Time Vector Nuances (Numeric Data)**](./14_Time_Vector_Nuances/README.md)
*   [**Example 15: Regional Trend Analysis**](./15_Regional_Trend_Analysis/README.md)

### Part 4: Interpreting Results & Validation
*   [**Example 16: Interpreting the Full Output**](./16_Interpreting_Output/README.md)
*   [**Example 17: Interpreting Analysis Notes**](./17_Interpreting_Analysis_Notes/README.md)
*   [**Example 18: Standalone Trend Classification**](./18_Standalone_Classification/README.md)
*   [**Example 19: Visual Diagnostics of Trend Plots**](./19_Visual_Diagnostics/README.md)
*   [**Example 20: Sen's Slope Methods for Censored Data (`sens_slope_method`)**](./20_Sens_Slope_Methods/README.md)

### Part 5: Advanced Seasonal Analysis
*   [**Example 21: Seasonal Trend with Weekly Data**](./21_Seasonal_Weekly_Data/README.md)
*   [**Example 22: Seasonal Trend with Daily Data (No Trend)**](./22_Seasonal_Daily_No_Trend/README.md)
*   [**Example 23: Seasonal Trend with Hourly Data**](./23_Seasonal_Hourly_Increasing_Trend/README.md)
*   [**Example 24: Advanced Seasonality with `day_of_year`**](./24_Seasonal_Day_Of_Year/README.md)
