...
```text
=== Topic 1: Kendall's Tau-a vs. Tau-b ===
Data with ties: [1 1 1 2 2 2 3 3 3 4]
Tau-a (No tie correction): 0.8000
Tau-b (Tie corrected):     0.8944

=== Topic 2: Custom Trend Classification ===
Default Classification: Highly Likely Increasing
Custom Classification:  Virtual Certainty Increasing

=== Topic 3: Minimum Sample Size Warning ===
n=3, min_size=5 -> Notes: ['< 5 Non-censored values', 'sample size (3) below minimum (5)']
