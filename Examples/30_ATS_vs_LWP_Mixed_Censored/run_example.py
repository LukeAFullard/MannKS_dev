...
def generate_example():
    """
    Generates an example comparing ATS, LWP, and Default methods on Mixed (Doubly) Censored data.
    """
    ...
    noise = np.random.normal(scale=3.0, size=n)
    y = y_true + noise

    # Impose Mixed Censoring:
    # Left censoring (LOD) at 10.0
    # Right censoring (Saturation) at 35.0
    lod = 10.0
    limit = 35.0
    ...
    # Plot path
    plot_path = os.path.join(os.path.dirname(__file__), 'mixed_censored_comparison.png')
...
"""
    ...
    print("Example 30 README.md generated successfully.")
