...
# --- 1. Data Generation ---
# Generate a dataset with a known positive trend and left-censoring
np.random.seed(42)
n = 50
...
# Introduce left-censoring for values below a threshold
...
plot_path = os.path.join(os.path.dirname(__file__), 'left_censored_plot.png')
...
mk_lwp = mk.trend_test(
    ...
    mk_test_method='lwp',
    ci_method='lwp',
    sens_slope_method='lwp' # Key for left-censored
)
...
print("Validation V-05 complete. README.md generated.")
