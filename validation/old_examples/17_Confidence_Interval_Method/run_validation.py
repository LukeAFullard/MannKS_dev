...
# --- 1. Data Generation ---
# Generate a simple dataset with a known positive trend
np.random.seed(42)
n = 50
...
# Run with LWP-emulation settings (ci_method='lwp')
...
## Data
A simple synthetic dataset of {n} annual samples was generated with a known positive slope. This dataset is identical to the one used in V-01.
...
print("Validation V-17 complete. README.md and plot generated.")
