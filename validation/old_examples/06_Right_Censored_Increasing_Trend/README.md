...
## Data
A synthetic dataset of 50 annual samples was generated with a positive slope. Values above `8.0` were converted to right-censored strings (e.g., `'>8.0'`). The generated plot from the standard `mannkensen` analysis is shown below.
